...
public final class ImmagineDAO implements DAO<Immagine> {
   ...
   public Immagine getById(final int id) {
      ...
      try (Connection connection = ConPool.getInstance().getConnection()) {
         if (connection != null) {
            ...
            if (resultSet.next()) {immagine = extract(resultSet, null);}
            }
         }
      }
   ...
   @Override
   public boolean save(Immagine entity) {
      if (entity != null) {
         try (Connection connection = ConPool.getInstance().getConnection()) {
            if (connection != null) {
               String query = "INSERT";
   ...
   @Override
   public boolean update(Immagine entity) {
      return false;
   }

   @Override
   public boolean delete(Immagine entity) {
      return false;
   }

   @Override
   public Immagine extract(ResultSet resultSet, String alias) {
      return null;
   }
}
